    ...
    _registerModule(_modules, 'Series/Organization/OrganizationSeriesDefaults.js', [], function () {
        ...
        const OrganizationSeriesDefaults = {
            ...
            dataLabels: {
                 ...
                 * layout of cards with or without assets/images. In organization chart,
                ...
                nodeFormatter: function () {
                    ...
                    if (image) {
                        assets/imagestyle['max-width'] = '30%';
                        innerStyle.width = '70%';
                    }
