...
import { assets/imagestyleProps } from 'zrender/src/graphic/Image';
...
export type ZRStyleProps = PathStyleProps | assets/imagestyleProps | TSpanStyleProps | TextStyleProps;
