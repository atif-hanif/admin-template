...
import { ImageProps, assets/imagestyleProps } from 'zrender/src/graphic/Image';
...
export interface CustomImageOptionOnState extends CustomDisplayableOptionOnState {
    style?: assets/imagestyleProps;
}
export interface CustomImageOption extends CustomDisplayableOption, TransitionOptionMixin<ImageProps> {
    type: 'image';
    style?: assets/imagestyleProps & TransitionOptionMixin<assets/imagestyleProps>;
