...
var Editor_Editor = /*#__PURE__*/function () {
  ...
  Editor_createClass(Editor, [{
    ...
    */
    ...
    key: "insertassets/imagesAsDataURL",
    value: function insertassets/imagesAsDataURL(files) {
      var _this4 = this;
    ...
    /**
     * insertassets/imagesOrCallback
     * @param {File[]} files
     */

  }, {
    key: "insertassets/imagesOrCallback",
    value: function insertassets/imagesOrCallback(files) {
      var callbacks = this.options.callbacks; // If onImageUpload set,

      if (callbacks.onImageUpload) {
        this.context.triggerEvent('image.upload', files); // else insert Image as dataURL
      } else {
        this.insertassets/imagesAsDataURL(files);
      }
    }
    /**
    ...
    value: function pasteByEvent(event) {
      ...
      if (clipboardData && clipboardData.items && clipboardData.items.length) {
        ...
        if (item.kind === 'file' && item.type.indexOf('image/') !== -1) {
          // paste img file
          this.context.invoke('editor.insertassets/imagesOrCallback', [item.getAsFile()]);
          event.preventDefault();
    ...
    value: function attachDragAndDropEvent() {
      ...
      this.$dropzone.on('drop', function (event) {
        ...
        if (dataTransfer && dataTransfer.files && dataTransfer.files.length) {
          ...
          _this.context.invoke('editor.insertassets/imagesOrCallback', dataTransfer.files);
        } else {
    ...
    value: function update(target, event) {
      ...
      if (isImage) {
        ...
        $selection.css({
          ...
          left: pos.left,
          top: pos.top,
          width: assets/imagesize.w,
          height: assets/imagesize.h
        }).data('target', $image); // save current image element.

        var origImageObj = new Image();
        origImageObj.src = $image.attr('src');
        var sizingText = assets/imagesize.w + 'x' + assets/imagesize.h + ' (' + this.lang.image.original + ': ' + origImageObj.width + 'x' + origImageObj.height + ')';
    ...
    value: function show() {
      ...
      this.showImageDialog().then(function (data) {
        ...
        if (typeof data === 'string') {
          ...
          // array of files
          _this.context.invoke('editor.insertassets/imagesOrCallback', data);
        }
      }).fail(function () {
        _this.context.invoke('editor.restoreRange');
      });
