...
var SVGRenderer = /** @class */ (function () {
    ...
    */
    ...
    SVGRenderer.prototype.image = function (src, x, y, width, height, onload) {
        var attribs = { preserveAspectRatio: 'none' }, setSVGassets/imagesource = function (el, src) {
        ...
        var elemWrapper = this.createElement('image').attr(attribs), onDummyLoad = function (e) {
            setSVGassets/imagesource(elemWrapper.element, src);
        ...
        if (onload) {
            ...
            setSVGassets/imagesource(elemWrapper.element, 'data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==' /* eslint-disable-line */);
    ...
    SVGRenderer.prototype.symbol = function (symbol, x, y, width, height, options) {
        ...
        var obj, path, assets/imagesrc, centerImage;
        if (symbolFn) {
            ...
            assets/imagesrc = symbol.match(imageRegex)[1];
            // Create the image synchronously, add attribs async
            var img_1 = obj = this.image(assets/imagesrc);
            // The image width is not always the same as the symbol width. The
            // image may be centered within the symbol, as is the case when
            // image shapes are used as label backgrounds, for example in flags.
            img_1.imgwidth = pick(symbolSizes[assets/imagesrc] && symbolSizes[assets/imagesrc].width, options && options.width);
            img_1.imgheight = pick(symbolSizes[assets/imagesrc] && symbolSizes[assets/imagesrc].height, options && options.height);
            /**
            ...
            if (defined(img_1.imgwidth) && defined(img_1.imgheight)) {
                ...
                createElement('img', {
                    onload: function () {
                        ...
                        // Fire the load event when all external assets/images are
                        // loaded
                        ren.imgCount--;
