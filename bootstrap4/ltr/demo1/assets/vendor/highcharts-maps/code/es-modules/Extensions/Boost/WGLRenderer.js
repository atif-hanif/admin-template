...
function GLRenderer(postRenderCallback) {
    ...
    function init(canvas, noFlush) {
        ...
        function createTexture(name, fn) {
            ...
            ctx.mozassets/imagesmoothingEnabled = false;
            ctx.webkitassets/imagesmoothingEnabled = false;
            ctx.msassets/imagesmoothingEnabled = false;
            ctx.assets/imagesmoothingEnabled = false;
