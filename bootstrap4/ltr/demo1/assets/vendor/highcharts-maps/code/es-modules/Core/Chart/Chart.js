 ...
 *        Function to run when the chart has loaded and and all external assets/images
...
var Chart = /** @class */ (function () {
     ...
     *
     * @param {Highcharts.ChartCallbackFunction} [callback]
     * Function to run when the chart has loaded and and all external assets/images are
     * loaded. Defining a
     * [chart.events.load](https://api.highcharts.com/highcharts/chart.events.load)
     * handler is equivalent.
     *
    ...
    Chart.prototype.firstRender = function () {
        ...
        // Fire the load event if there are no external assets/images
    ...
    /**
     * Internal function that runs on chart load, async if any assets/images are loaded
