declare module "froala-editor" {
  ...
  export interface FroalaOptions {
    ...
    multiLine: boolean;
    pasteAllowLocalassets/images: boolean;
    ...
    assets/imagesizeButtons: string[];
    assets/imagesplitHTML: boolean;
    assets/imagestyles: GenericObject<string>; 
  ...
  export interface FroalaEvents {
    ...
    'image.hideResizer': (this: FroalaEditor, assets/images: any) => boolean;
    ...
    'imageManager.assets/imagesLoaded': (this: FroalaEditor, data: any) => void;
    //link event
  ...
  export interface FilesManager {
    ...
    applyStyle(val: any, assets/imagestyles: any, multipleStyles: any): boolean;
    showAltPopup(): void;
    showSizePopup(): void;
    setAlt(alt: any): void;
  ...
  export interface Image {
    ...
    upload(assets/images: any[]): object;
    insertByURL(): void;
    ...
    showProgressBar(no_message: any): void;
    hideProgressBar(dismiss: any): void;
    applyStyle(val: any, assets/imagestyles: any, multipleStyles: any): object;
    showAltPopup(): void;
    showSizePopup(): void;
    toggleCaption(): void;
    hasCaption(): void;
