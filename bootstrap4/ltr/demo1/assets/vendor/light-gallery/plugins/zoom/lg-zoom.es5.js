...
var Zoom = /** @class */ (function () {
    ...
    Zoom.prototype.enableZoom = function (event) {
        ...
        this.zoomableTimeout = setTimeout(function () {
            if (!_this.isassets/imageslide(_this.core.index)) {
                return;
            }
    ...
    Zoom.prototype.zoomImage = function (scale, scaleDiff, reposition, resetToMax) {
        ...
        this.top = y;
        if (resetToMax) {
            this.setZoomassets/imagesize();
        }
    };
    Zoom.prototype.resetImageTranslate = function (index) {
        if (!this.isassets/imageslide(index)) {
            return;
        }
    ...
    Zoom.prototype.setZoomassets/imagesize = function () {
        var _this = this;
        var $image = this.core
            .getSlideItem(this.core.index)
            .find('.lg-image')
    ...
    Zoom.prototype.init = function () {
        ...
        this.core.LGel.on(lGEvents.containerResize + ".zoom " + lGEvents.rotateRight + ".zoom " + lGEvents.rotateLeft + ".zoom " + lGEvents.flipHorizontal + ".zoom " + lGEvents.flipVertical + ".zoom", function () {
            if (!_this.core.lgOpened ||
                !_this.isassets/imageslide(_this.core.index) ||
    ...
    Zoom.prototype.zoomIn = function () {
        // Allow zoom only on image
        if (!this.isassets/imageslide(this.core.index)) {
            return;
        }
    ...
    Zoom.prototype.isassets/imageslide = function (index) {
